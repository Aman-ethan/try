  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-y-4 lap:flex-row lap:gap-x-8">
        <div className="flex-1 rounded-lg shadow bg-white p-6 lap:flex-1 lap:max-w-[30rem]">
          <ClientNetWorth />
        </div>
        <div className="flex-1 rounded-lg shadow bg-white p-6 pb-0">
          <AssetNetWorth />
        </div>
      </div>
      <div className="rounded-lg shadow bg-neutral-1 p-6">
        <Analytics />
      </div>
      <div className="space-y-6 rounded-lg shadow bg-white p-6">
